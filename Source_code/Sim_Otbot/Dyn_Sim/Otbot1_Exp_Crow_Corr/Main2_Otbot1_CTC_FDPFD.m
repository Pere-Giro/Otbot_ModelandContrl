...
u_Flag = 'VAR'; % Flag to define if you want a constnat torque for all simulation or not
...
global sstates
global zstatestsnew
load("Crow_Corr_Data/crow_corr_ts")

% global OLstates
% load("Crow_Corr_Data/OLstatesCOMSep")

% global OLstatesCoMpp
% load("Crow_Corr_Data/OLstatesCOMpp")
 
% global CLstatesCoMpp % Using forward dynamics
% load("Crow_Corr_Data/CLstatesCOMppFwdDyn")

% global CLstatesCoMppdiff % Using diff old CTC with Tstab = 5s
% load("Crow_Corr_Data/CLstatesCOMppDiff")

global CLstatesCoMppdiffNCTC % Using diff new CTC with Tstab = 3s
load("Crow_Corr_Data/CLstatesCOMppDiffNCTC")

% Now load the accelerations for the CTC Option Fordward
% dynamics
% global pddotts
% load("Crow_Corr_Data/pddot_ts")

% Loading the data for the CTC option diff

global CTCd_ts 

load("Crow_Corr_Data/crow_corr_diff_traj")
...
dxdt= @(t,xs) xdot2_otbot1_CTC_FDPFD(t, xs, m, sm, u, u_Flag, cp, goal_Flag, FrictFlag, DistFlag, u_IntFlag, Int_Vec, uactionts);
...
if strcmp(UvecFlag,'YES')
    ...
    switch u_Flag
        ...
        case 'VAR'
            ls = length(states);
            for i=1:ls
                u_f= u_function(times(i),uactionts);
...
%------------------------------------------------------------------%
% Plots in small square version
%------------------------------------------------------------------%

figure;
plot(times,states(:,1))
xlabel('t [s]','Interpreter','latex' ),ylabel('$x$ [m]','Interpreter','latex' ),title('Configuration','Interpreter','latex' )
grid on

figure;
plot(times,states(:,2))
xlabel('t [s]','Interpreter','latex' ),ylabel('$y$ [m]','Interpreter','latex' ),title('Configuration','Interpreter','latex' )
grid on

figure;
plot(times,states(:,3))
xlabel('t [s]','Interpreter','latex' ),ylabel('$\alpha$ [rad]','Interpreter','latex' ),title('Configuration','Interpreter','latex' )
grid on

figure;
plot(times,states(:,4))
xlabel('t [s]','Interpreter','latex' ),ylabel('$\varphi_r$ [rad]','Interpreter','latex' ),title('Configuration','Interpreter','latex' )
grid on

figure;
plot(times,states(:,5))
xlabel('t [s]','Interpreter','latex' ),ylabel('$\varphi_l$ [rad]','Interpreter','latex' ),title('Configuration','Interpreter','latex' )
grid on

figure;
plot(times,states(:,6))
xlabel('t [s]','Interpreter','latex' ),ylabel('$\varphi_p$ [rad]','Interpreter','latex' ),title('Configuration','Interpreter','latex' )
grid on

figure;
plot(times,states(:,7))
xlabel('t [s]','Interpreter','latex' ),ylabel('$\dot{x}$ [m/s]','Interpreter','latex' ),title('Velocity','Interpreter','latex' )
grid on

figure;
plot(times,states(:,8))
xlabel('t [s]','Interpreter','latex' ),ylabel('$\dot{y}$ [m/s]','Interpreter','latex' ),title('Velocity','Interpreter','latex' )
grid on
...
figure;
plot(times,states(:,10))
xlabel('t [s]','Interpreter','latex' ),ylabel('$\dot{\varphi}_r$ [rad/s]','Interpreter','latex' ),title('Velocity','Interpreter','latex' )
grid on

figure;
plot(times,states(:,11))
xlabel('t [s]','Interpreter','latex' ),ylabel('$\dot{\varphi}_l$ [rad/s]','Interpreter','latex' ),title('Velocity','Interpreter','latex' )
grid on

figure;
plot(times,states(:,12))
xlabel('t [s]','Interpreter','latex' ),ylabel('$\dot{\varphi}_p$ [rad/s]','Interpreter','latex' ),title('Velocity','Interpreter','latex' )
grid on
...
if strcmp(KinEnFlag,'YES')
    figure;
    plot(times,kinenvalues)
    xlabel('t [s]','Interpreter','latex' ),ylabel('Kinetic Energy [J]','Interpreter','latex' ), title('System Energy','Interpreter','latex' )
    grid on
end
...
if strcmp(ErrorFlag,'YES') && uswitch
    ...
    figure;
    plot(times,errorstates(:,6))
    xlabel('t [s]','Interpreter','latex' ),ylabel('$\dot{\alpha}$ error [m/s]','Interpreter','latex' ),title('Velocity error in $\dot{\alpha}$','Interpreter','latex' )
    grid on
