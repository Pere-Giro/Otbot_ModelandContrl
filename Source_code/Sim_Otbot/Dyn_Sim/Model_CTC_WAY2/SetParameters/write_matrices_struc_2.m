...
load("Lambmat.mat")
load("fikdot_iikdotofq_matrices.mat")
...
%% For the WAY 2 Simulation model we need the derivatives of MIIK 
% We will also add MFIK time derivative

MIIKdotmatrix = subs(MIIKdot,[l_1,l_2,r],[m.l_1,m.l_2,m.r]);
% Save matrix in a structure array
sm.MIIKdotamatrix = matlabFunction(MIIKdotmatrix);

MFIKdotmatrix = subs(MFIKdot,[l_1,l_2,r],[m.l_1,m.l_2,m.r]);
% Save matrix in a structure array
sm.MFIKdotamatrix = matlabFunction(MFIKdotmatrix);
...
save('C:\Users\pereg\Documents\UPC\Master\TFMPractiques\MatlabWD\Sim_Otbot\Dyn_Sim\Model_CTC_WAY2\sm_struc.mat',"sm","sm")
clearvars
close all
clc
