...
nlgrm.parameters(15).Fixed = FixorNot(15,1); % Abias [nounit]
nlgrm.parameters(16).Fixed = FixorNot(16,1); % Xbias [nounit]
nlgrm.parameters(17).Fixed = FixorNot(17,1); % Ybias [nounit]
