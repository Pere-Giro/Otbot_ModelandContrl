...
xlabel('t [s]','Interpreter','latex'),ylabel('$\dot{alpha}$ [m/s])','Interpreter','latex'),title('Velocity','Interpreter','latex')

% Plot x_ddot coordinate
figure;
plot(data.SamplingInstants, data.OutputData(:,2),'.')
xlabel('t [s]','Interpreter','latex'),ylabel('$\ddot{x}$ [m/$\mathrm{s}^2$]','Interpreter','latex'),title('Acceleration','Interpreter','latex')

% Plot varphidot_l coordinate
figure;
plot(data.SamplingInstants, data.OutputData(:,3),'.')
xlabel('t [s]','Interpreter','latex'),ylabel('$\ddot{y}$ [m/$\mathrm{s}^2$]','Interpreter','latex'),title('Acceleration','Interpreter','latex')
