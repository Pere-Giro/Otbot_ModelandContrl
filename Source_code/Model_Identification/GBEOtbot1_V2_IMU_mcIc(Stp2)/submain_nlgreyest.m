...
if CESFlag == 1
    ...
    ParameterName = {'I_b'; 'I_p'; 'I_a'; 'I_t'; 'l_1'; 'l_2'; 'm_b'; 'm_w'; 'm_p'; 'x_G'; 'y_G'; 'x_F'; 'y_F'; 'r'; 'b_r'; 'b_l'; 'b_p'};
    RelativeError_Percentage = rel_error(ParameterRealValues, ParameterFinalValues);
    StDev = pvec_sd;
    Units = {'kg*m^2'; 'kg*m^2'; 'kg*m^2'; 'kg*m^2'; 'm'; 'm'; 'kg'; 'kg'; 'kg'; 'm'; 'm'; 'm'; 'm'; 'm'; 'kg*m^2*s^-1'; 'kg*m^2*s^-1'; 'kg*m^2*s^-1'};
