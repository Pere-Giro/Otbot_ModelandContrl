...
% fullsavename = strcat('Final_Pars_Sim/Otbot1_CTC_W1_DF_IMU/SetParameters/',filename,Tsvalue,'s_',percent,'.mat');
fullsavename = strcat(PartialDirNameExcel,'/',filename,Tsvalue,'s_',percent,'.mat');
fullsavename2 = strcat('Final_Pars_Sim/Otbot1_CTC_W1_DF_IMU/SetParameters/',filename,'.mat');
